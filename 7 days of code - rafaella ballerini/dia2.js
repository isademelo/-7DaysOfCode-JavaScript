...
while (nome == ""){
    alert("Você nao digitou o seu nome!");
...
while (linguagem == ""){
    alert("Digite uma linguagem de programação!");
    linguagem = prompt("Qual linguagem de programação você está estudando?");
}

console.log(`Olá ${nome}, você tem ${idade} anos de idade e ja está aprendendo ${linguagem}`);

//exercício opcional

let gosta = prompt(`Você gosta de estudar ${linguagem}? Responda com SIM ou NÃO.`);

if (gosta.toUpperCase() === "SIM"){
    alert("Muito bom! Continue estudando e você terá muito sucesso.");
} else if (gosta.toUpperCase() === "NÃO" || gosta.toUpperCase() === "NAO"){
    alert("Ahh que pena... Já tentou aprender outras linguagens?");
} else {
    alert("Resposta não reconhecida. Mas tudo bem! O importante é seguir curioso e aberto a aprender.");
}